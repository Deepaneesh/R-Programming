...
In tidymodels, the metric_set() function is used to bundle together multiple performance metrics that you want to evaluate for a model.

📌 Common functions available in metric_set()
These functions are part of the yardstick package, which tidymodels uses for metrics. Here's a categorized list of available metrics:
